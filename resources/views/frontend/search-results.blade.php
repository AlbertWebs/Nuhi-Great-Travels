                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6">
                        <div class="listing-one__single">
                            <div class="listing-one__img">
                                <img style="height:300px; width:100%; object-fit:cover" src="{{ asset('storage/' . $fleet->image) }}" alt="{{ $fleet->make }}">
                                ...
                                <div class="listing-one__meta-box-info">
                                    <ul class="list-unstyled listing-one__meta">
                                        <li>
                                            ...
                                            <div class="text"><p>{{ $fleet->transmission ?? 'Manual' }}</p></div>
                                        </li>

                                        <li>
                                            <div class="icon"><span class="icon-fuel-type"></span></div>
                                            <div class="text"><p>{{ $fleet->fuel_type ?? 'Petrol' }}</p></div>
                                        </li>
                                        <li>
                                            <div class="icon"><span class="icon-in-person"></span></div>
                                            <div class="text"><p>{{ $fleet->capacity ?? '5 Persons' }}</p></div>
                                        </li>
                                    </ul>
